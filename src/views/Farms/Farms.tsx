  ...
  return (
    <Page>
      <Heading as="h1" size="lg" color="text" mb="50px" style={{ textAlign: 'center' }}>
        {
          tokenMode ?
            TranslateString(10002, 'Stake tokens to earn TOKEN')
            :
          TranslateString(320, 'Stake LP tokens to earn TOKEN')
        }
      </Heading>
      <Heading as="h2" color="text" mb="50px" style={{ textAlign: 'center' }}>
        {TranslateString(10000, 'Deposit Fee will be used to buyback TOKEN')}
      </Heading>
